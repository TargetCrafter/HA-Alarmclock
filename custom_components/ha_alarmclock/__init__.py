...
alarm switch, pressing snooze/dismiss) are published as `ha_alarmclock_command` events on the HA
event bus, which the app receives over Home Assistant's own WebSocket API.
"""
